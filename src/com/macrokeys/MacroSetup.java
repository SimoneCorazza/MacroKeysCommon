...
public final class MacroSetup implements Serializable {
    ...
    /**
     * The Screens that compose this setup
     */
    ...
    /**
     * @param l the Screens to include
     ...
     * <p>To deepen the exceptions contained in the {@link MSLoadException}
     * see {@link ObjectInputStream#readObject()}</p>
     ...
     */
    @NonNull
    public static MacroSetup load(@NonNull String path) throws IOException, MSLoadException {
     ...
     */
    @NonNull
    public static MacroSetup load(@NonNull InputStream instr) throws IOException, MSLoadException {
     ...
     * <br/>
     * The keys have a minute size which cannot be exceded.
     * @param width Space on the X axis in millimiters
     * @param height the Space on the Y axis in millimiters
     * @return Copy of this instance with the related {@link MacroScreen}s
     ...
     * @return the Date that rapresents this intance
     * @throws IOException If an IO error occurs
     */
     ...
     * @param id the If of the {@link MacroKey} to get
     * @return Obtained key
     */
    ...
    /**
     * @return the Selected {@link MacroScreen}
     */
    @NonNull
     ...
     * @return True if the {@code.} is associated with a {@link MacroScreen} and was successful changesd
     */
