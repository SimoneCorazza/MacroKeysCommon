...
public class MacroSetupTest {
    ...
    public class SaveAndLoadTest {
        ...
        @Test
        public void shouldSaveAndLoadCorrectly() throws IOException, MSLoadException {
    ...
    public class FitForTest {

        @Test
        public void shouldFitKeys() {
        ...
        @Test
        public void shouldFitKeysExcedeOnXAxis() {
            final float F_X = 50, F_Y = 100;
        ...
        @Test
        public void shouldFitKeysExcedeOnYAxis() {
            final float F_X = 50, F_Y = 100;
            MacroScreen s = new MacroScreen();
        ...
        @Test
        public void shouldNotEditKeysIfAllOfThemFit() {
            final float F_X = 50, F_Y = 100;
    ...
    @Test
    public void shouldEqualsReturnTrue() throws CloneNotSupportedException {
        MacroScreen s1 = new MacroScreen();
        MacroKey k = new MacroKey();
        s1.getKeys().add(k);
