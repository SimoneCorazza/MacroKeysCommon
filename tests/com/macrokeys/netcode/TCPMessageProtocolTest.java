...
public class TCPMessageProtocolTest {
    ...
    private static void assertReceiveMessageAB(TCPMessageProtocol a, TCPMessageProtocol b, byte[] msg) throws IOException {
        a.sendMessage(msg);
        byte[] r = b.receiveMessage();
        assertTrue(Arrays.equals(msg, r), "Messages must be equal");
    }

    private static void assertReceiveMessage(TCPMessageProtocol a, TCPMessageProtocol b, byte[] msg) throws IOException {
